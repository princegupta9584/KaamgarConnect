...
// Static Files Configuration (Very Important for Render)
app.use(express.static(path.join(__dirname, 'public')));

// --- DATABASE CONNECTION ---
// Render ke dashboard me MONGO_URI variable zaroor daalna
...
// Isse page refresh karne par "Cannot GET" error nahi aayega
// Ensure karo upar const path = require('path'); likha hai
app.get('*', (req, res) => {
